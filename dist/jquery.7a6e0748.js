...
},{"process":"../../../AppData/Local/Yarn/Data/global/node_modules/process/browser.js"}],"jquery.js":[function(require,module,exports) {
...
window.jQuery = function (selectorOrArray) {
  ...
  }), _defineProperty(_ref, "end", function end() {
    return this.oldApi; //this就是新的Api
  }), _defineProperty(_ref, "addClass", function addClass(className) {
    for (var i = 0; i < elements.length; i++) {
      elements[i].classList.add(className);
    }

    return this; // let newApi = jQuery(array)
    // return newA
  }), _ref;
};
